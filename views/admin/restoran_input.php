    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Restoran</h2>
                <form action="/../../index.php?modul=restoran&fitur=add" method="POST" enctype="multipart/form-data">
                    <!-- Nama Restoran -->
                    <div class="mb-4">
                    ...
                    <!-- Gambar Restoran -->
                    <div class="mb-4">
                        <label for="restoran_gambar" class="block text-gray-700 text-sm font-bold mb-2">Upload Gambar:</label>
                        <input type="file" id="restoran_gambar" name="restoran_gambar" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" accept="image/*" required>
                    </div>
